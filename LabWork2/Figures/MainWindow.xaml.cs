...
namespace Figures
{
    ...
    public partial class MainWindow : Window
    {
        ...
        internal struct ShapeInfoStruct
        {
            ...
            internal delegate List<Point> createShape(int[] vals, Brush br);
        ...
        internal static ShapeInfoStruct[] ShapeInfo =
                                            new ShapeInfoStruct[]
                                            {
                                                new ShapeInfoStruct("Rectangle", 4, Rectangle.Create),
                                                new ShapeInfoStruct("Ellipse", 4, Ellipse.Create),
                                                new ShapeInfoStruct("Triangle", 6, Triangle.Create),
                                                new ShapeInfoStruct("Segment", 4, Segment.Create)
                                            };
